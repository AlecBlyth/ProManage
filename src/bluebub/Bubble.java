...
public class Bubble extends Group {
    ...
    private int pm = 10;
    private int sm = 2;
    private Font textFont = Font.font("Segoe UI", 18);
    private Paint textColor = Color.WHITE;
    private Font metaFont = Font.font("Segoe UI", 12);
    ...
    public void setBubbleColor(Paint bubbleColor) {
        r.setFill(bubbleColor); //PREVIOUS CODE DIDN'T CHANGE COLOUR SO FIXED IT - Alec
